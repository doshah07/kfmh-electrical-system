(() => {
  ...
  // Keep one internal index inside the same system. No standalone links or QR
  // blocks are created for transformers, MDP, MP or PP pages.
  function addQuickIndex(){
    ...
    section.innerHTML = `
      ...
      <p>${tr('من داخل النظام نفسه: افتح MDP ثم لوحات MP التابعة لها.','Inside the same system: open each MDP and its MP pages.')}</p>
